      ...
      <div className="container mx-auto px-4 lg:px-8 py-14 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="space-y-4 md:col-span-2">
            <div className="flex items-center">
              <h2 className="text-white text-2xl font-semibold" itemProp="name">
                BOSKA RESORT
              </h2>
            </div>
            <p className="text-sm text-gray-400" itemProp="description">
              Experience luxury amidst Wayanad's natural splendor at Boska Resort. 
              Our eco-conscious retreat offers premium amenities and authentic 
              Kerala hospitality for unforgettable stays in the Western Ghats.
            </p>
          </div>
          ...
          <nav aria-label="Quick links">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/reviews" className="hover:text-white transition-colors duration-200" aria-label="Guest reviews">Guest Reviews</a></li>
              <li><a href="/faq" className="hover:text-white transition-colors duration-200" aria-label="Frequently asked questions">FAQ</a></li>
            </ul>
          </nav>
          ...
          <address className="not-italic">
            ...
            <ul className="space-y-2" itemScope itemType="https://schema.org/LodgingBusiness">
              <li itemProp="address" itemScope itemType="https://schema.org/PostalAddress">
                ...
                <span itemProp="addressLocality">Wayanad</span>,{" "}
                <span itemProp="addressRegion">Kerala</span> -{" "}
                <span itemProp="postalCode">670731</span>,{" "}
                <span itemProp="addressCountry">India</span>
              </li>
              <li>
                <a href="tel:+918157880985" itemProp="telephone" className="hover:text-white transition-colors duration-200">
                  +91 81578 80985
                </a>
              </li>
              <li>
                <a href="mailto:bookings@boskaresort.com" itemProp="email" className="hover:text-white transition-colors duration-200">
                  bookings@boskaresort.com
                </a>
              </li>
            </ul>
          </address>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              {/* Other social icons with similar modifications */}
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 text-sm text-gray-400">
          <div className="text-center">
            <p>
              © {new Date().getFullYear()} Boska Resort Wayanad. All rights reserved. 
            </p>
          </div>
        </div>
      </div>
