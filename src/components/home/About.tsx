  ...
  return (
    <div className="flex items-center justify-center  py-16 lg:py-24">
      <div className="container mx-auto px-4 lg:px-8 text-start">
        ...
        {/* New CTA Button */}
        <button className="rounded-lg px-8 py-4 text-sm uppercase tracking-widest border border-[#B59D71] text-black hover:text-white hover:bg-[#B59D71] transition-colors duration-300 flex items-center  gap-3">
          Explore Services
